...
Passageiro lerDadosPassageiro(int numeroVoo){
    ...
    getline(cin, passageiro.numeroPassagem);

    cout << "Número da Poltrona: ";
    getline(cin, passageiro.numeroPoltrona);
...
void menuSecundario(int numeroVoo){
    ...
    while(true){
        ...
        if(numeroVoo == BH_RIO){
            cout << "EMPRESA AÉREA GALO DOIDO - VOO BH-RIO" << endl;
        }else if(numeroVoo == BH_SP){
            cout << "EMPRESA AÉREA GALO DOIDO - VOO BH-SP" << endl;
        }else{
            cout << "EMPRESA AÉREA GALO DOIDO - VOO BH-BRASILIA" << endl;
        }
